...
#My own 5 targets
targets = [
    transform(np.array([0.35, 0.15, 0.45]), np.array([0, pi, pi])),
    transform(np.array([0.40, -0.20, 0.40]), np.array([0, pi, pi])),
    transform(np.array([0.30, 0.25, 0.55]), np.array([pi/6, pi, pi])),
    transform(np.array([0.45, 0.00, 0.35]), np.array([0, 5*pi/6, pi])),
    transform(np.array([0.25, -0.25, 0.50]), np.array([pi/8, pi, 5*pi/6]))
]
